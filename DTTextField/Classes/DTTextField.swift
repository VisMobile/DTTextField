...
open class DTTextField: UITextField {
	...
	fileprivate let paddingX:CGFloat                        = 16.0
	
	fileprivate let paddingHeight:CGFloat                   = 6.0
	...
	//        didSet{ invalidateIntrinsicContentSize() }
	//    }
	public var floatPlaceholderFont = UIFont(name: "OpenSans-Light", size: 12){
		didSet{ invalidateIntrinsicContentSize() }
	}
	...
	fileprivate func commonInit() {
		...
		floatPlaceholderColor       = UIColor(red: 152.0/255.0, green: 158.0/255.0, blue: 162.0/255.0, alpha: 1.0)
		// floatPlaceholderColor       = UIColor.red
		...
		//lblFloatPlaceholder.font = FontHelper.openSansLightFontWithSize(size: 17)
		lblFloatPlaceholder.text    = placeholderFinal
		...
		lblError.textColor          = UIColor(red: 153.0/255.0, green: 0.0/255.0, blue: 0.0/255.0, alpha: 1.0)
	...
	override open func layoutSubviews() {
		...
		//20 for padding 10 from left & 10 from right
		lblFloatPlaceholder.frame = CGRect(x: x, y: lblFloatPlaceholder.frame.origin.y,
		                                   width: floatingLabelSize.width + 20,
